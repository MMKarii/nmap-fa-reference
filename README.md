<p align="center">
  <img src="docs/fa/assets/brand-banner.webp" alt="Nmap Professional Reference" width="100%">
</p>
...
<p align="center">Bilingual Persian and English documentation for structured learning, quick reference, and authorized security assessment.</p>
<p align="center">مستند دو زبانه فارسی و انگلیسی برای یادگیری ساختارمند، مراجعه سریع و ارزیابی امنیتی مجاز.</p>
...
Both editions use matching chapter numbers and filenames. The Persian edition remains the structural source of truth, while the English edition uses standard Nmap and security terminology.
...
This is a general assessment pattern, not a universal command. Scope, network capacity, and authorization determine appropriate parameters.
